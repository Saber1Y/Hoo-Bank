  ...
  return (
    <nav className="w-full flex py-2 justify-between items-center navbar">
     ...
     ${index === navLinks.length - 1 ? "mb-4" : "mr-10"} text-white mr-10`}
      ...
      <button
        type="button"
        className="text-dark bg-[#a8eff2] hover:bg-[#a8eff2]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#a8eff2]/55 me-2 mb-2"
      >
        <svg
